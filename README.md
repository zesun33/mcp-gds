...
| `gds_stream_out` | `def_file: string`, `gds_file?: string`, `cwd?: string` | KLayout + Nangate45 LEFs | DEF-to-GDSII stream-out (abstract cell footprints; full transistor GDS needs the PDK). |
